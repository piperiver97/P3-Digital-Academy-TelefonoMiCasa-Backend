...
VALUES 
(150000, 'Hermoso apartamento con vista al mar.', 'Calle del Mar 123, Gijón', 85.0, 'venta', 'FLAT', 2, 1, true, 5, 4),
(1200, 'Piso céntrico en alquiler, bien comunicado.', 'Plaza Mayor 789, Avilés', 60.0, 'alquiler', 'FLAT', 1, 1, false, 1, 3),
(180000, 'Moderno apartamento en la ciudad.', 'Avenida de la Libertad 45, Oviedo', 75.0, 'venta', 'FLAT', 2, 2, true, 3, 4),
...
VALUES 
(250000, 'Casa espaciosa con jardín y piscina.', 'Calle del Jardín 10, Gijón', 150.0, 'venta', 'HOUSE', 4, 2, 2, 4),
(180000, 'Acogedora casa en una zona tranquila.', 'Calle de la Paz 45, Avilés', 120.0, 'venta', 'HOUSE', 3, 1, 1, 3),
(1500, 'Casa en alquiler, ideal para familias.', 'Avenida de la Familia 22, Oviedo', 110.0, 'alquiler', 'HOUSE', 3, 2, 1, 4),
...
VALUES 
(50000, 'Trastero amplio en el centro de la ciudad.', 'Calle de la Almacen 1, Gijón', 20.0, 'venta', 'STORAGEROOM', 4),
(400, 'Pequeño trastero ideal para guardar bicicletas.', 'Calle del Garaje 10, Avilés', 10.0, 'alquiler', 'STORAGEROOM', 4),
...
INSERT INTO Property (price, description, address, area, action, property_type, user_id)
VALUES 
(20000, 'Garaje cerrado en el centro de la ciudad.', 'Calle de la Estacion 5, Gijón', 18.0, 'venta', 'GARAGE',4 ),
(150, 'Plaza de garaje en alquiler, fácil acceso.', 'Calle de la Libertad 8, Avilés', 12.0, 'alquiler', 'GARAGE', 3),
(25000, 'Garaje amplio con espacio para dos coches.', 'Avenida de la Paz 20, Oviedo', 25.0, 'venta', 'GARAGE', 4),
